<template>
	<div class="container-fluid p-0">
		<div class="d-flex my-3 mx-8">
			<div class="">
				<h4 class="text-success mt-1">Editar Contacto</h4>
			</div>
		</div>
		<div class="d-flex my-3 mx-8">
	...
	<div class="container-fluid p-0">
        <div class="row my-5 mx-8">
			<div class="col-md-9 mx-auto border p-3">
				<form @submit.prevent="editContactForm()" class="">
					<div class="row mb-3 pr-0">
						...
						<div class="col wd-600 pl-0">
							<input v-model="contact.name" type="text" class="form-control" id="inputName">
						</div>
                        <div class="col wd-170 pr-0">
							<label for="inputPhoto" class="col-form-label">Fotografía:</label>
						</div>
						<div class="col wd-400 pl-0">
							<input v-model="contact.photoURL" type="text" name="inputPhoto" id="inputPhoto" class="form-control">
                        </div>
                        <div class="col wd-65 pl-0">
                    ...
                    <div class="row mb-3 pr-0">
						...
						<div class="col wd-600 pl-0">
							<input v-model="contact.mobile" type="tel" class="form-control" id="inputPhoneMobile">
						</div>
                        <div class="col wd-170 pr-0">
							<label for="inputPhone" class="col-form-label">Teléfono fijo:</label>
						</div>
						<div class="col wd-600 pl-0">
							<input v-model="contact.phone" type="tel" class="form-control" id="inputPhone">
						</div>
                    </div>					
					<div class="row mb-3 pr-0">
						<div class="col wd-170 pr-0">
						...
						<div class="col wd-600 pl-0">
							<input v-model="contact.email" type="email" class="form-control" id="inputEmail">
						</div>
						<div class="col wd-170 pr-0">
							<label for="selectGroup" class="col-from-label">Grupo:</label>
						</div>
						<div class="col wd-600 pl-0">
							<select v-model="contact.groupId" v-if="groups.length > 0" name="selectGroup" id="selectGroup" class=" form-select">
...
export default {
    name: 'EditContact', data: function(){
		return {
		...
		editContactForm: async function (){
			try {
